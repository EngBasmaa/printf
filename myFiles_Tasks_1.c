			   ...
			   int flags, int w, int prs, int size)
{
	...
	prntdchrs = -1;
	ftt_t ftt_typs[] = {
		{'c', pr_char_fn}, {'s', pr_string_fn}, {'%', pr_percent_fn}, {'i', pr_int_fn}, {'b', pr_binary_fn}, {'X', pr_hexa_upper_fn}, {'u', pr_unsigned_fn}, {'x', pr_hexadecimal_fn}, {'\0', NULL}, {'d', pr_int_fn}, {'p', pr_pointer_fn}, {'S', pr_non_printable_fn}, {'r', pr_reverse_fn}, {'R', pr_rotString_fn}, {'o', pr_octal_fn}};
